...
async function post(config, params = {}) {
...
module.exports = function(config = {}) {
  if (
    !(config.domain && config.username && config.password && config.cachePath)
  ) {
    throw new Error('domain,username,password,cachePath is required');
  }
  return {
    post(params) {
